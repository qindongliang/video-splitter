...
const OutputSelector: React.FC<OutputSelectorProps> = ({
    ...
    return (
        <div className="flex items-center space-x-4">
            <label className="text-sm font-medium text-slate-300 w-24">
                📂 输出目录
            </label>
            <div className="flex-1 flex items-center space-x-2">
                <div
                    className={`
            flex-1 px-3 py-2 rounded-lg bg-slate-800/50 border border-slate-600
            text-sm truncate
          ...
          `}
                ...
                <button
                    ...
                    disabled={disabled}
                    className={`
            px-4 py-2 rounded-lg bg-slate-700 text-slate-300
